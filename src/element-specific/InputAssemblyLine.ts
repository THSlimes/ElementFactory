...
/**
 * A BasicAssemblyLine for the `<input>` element.
 *
...
class InputAssemblyLine<T extends InputAssemblyLine.Type, P extends AssemblyLine.Parameters> extends BasicAssemblyLine<HTMLInputElement, P> {
    ...
    /**
     * Adds a step that sets the input's value.
    ...
    /**
     * Adds a step that sets the input's name.
    ...
    /**
     * Adds a step that determines whether the input is disabled.
    ...
    /**
     * Adds a step that determines whether the input is required.
...
/**
 * Special subtype of InputAssemblyLine for types that act line buttons.
 */
...
/**
 * Special subtype of InputAssemblyLine for the image type.
 */
export class ImageInputAssemblyLine<P extends AssemblyLine.Parameters> extends InputAssemblyLine<InputAssemblyLine.Type.IMAGE, P> {
    ...
    /**
     * Adds a step that sets the image's source link.
...
/**
 * Special subtype of InputAssemblyLine for text-like input types.
 */
export class TextLikeInputAssemblyLine<T extends TextLikeInputAssemblyLine.Type, P extends AssemblyLine.Parameters> extends InputAssemblyLine<T, P> {
    ...
    /**
     * Adds a step that sets the placeholder (text when empty).
     * @param placeholder value provider
     */
    ...
    /**
     * Adds a step that determines a pattern for the value to match.
     * @param pattern value provider
     */
    ...
    /**
     * Adds a step that sets the minimum number of required characters.
    ...
    /**
     * Adds a step that sets the maximum number of required characters.
...
/**
 * Special subtype of InputAssemblyLine for input types that check be checked.
 */
export class CheckableInputAssemblyLine<T extends CheckableInputAssemblyLine.Type, P extends AssemblyLine.Parameters> extends InputAssemblyLine<T, P> {
    ...
    /**
     * Adds a step that determines whether the input is checked.
     * @param isChecked value provider
     */
...
/**
 * Special subtype of InputAssemblyLine for input types that deal with number values.
 */
export class NumberLikeInputAssemblyLine<T extends NumberLikeInputAssemblyLine.Type, P extends AssemblyLine.Parameters> extends InputAssemblyLine<T, P> {
    ...
    /**
     * Adds a step that sets a minimum value.
    ...
    /**
     * Adds a step that sets a maximum value.
    ...
    /**
     * Adds a step that sets a minimum increment.
     * @param step value provider
     */
